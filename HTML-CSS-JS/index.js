...
// let discountAge=prompt("Enter age: ")
// if(discountAge<6) console.log("Free");
// else if (discountAge>6 && discountAge<17) console.log("Child discount");
// else if (discountAge>18 && discountAge<26) console.log("Student discount");
// else if (discountAge>26 && discountAge<66) console.log("full price");
// else console.log("Senior Citizen discount");

// let largeCountry=["India","Russia","USA","China","Japan"]
// console.log(largeCountry);

// largeCountry.push("California")
// console.log(largeCountry);
// largeCountry.pop();
// console.log(largeCountry);
// largeCountry.unshift("Finland")
// console.log(largeCountry);
// largeCountry.shift();
// console.log(largeCountry);
...
const patient="Soham"
const doctor="AIIMS"
const email=`Hey ${patient}! Hows it's going cheers up from ${doctor}`
console.log(email);
